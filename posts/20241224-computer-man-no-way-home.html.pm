...
It's hard to make sense of it all. Maybe it doesn't matter if I make sense of it. Life moves on inexorably and there's no way back and that's all part of the fun. I wrote (a long time ago now, it feels) in a college application essay about the myth of square one --- it's impossible to erase what's been done, the tabula rasa no longer exists, so stop worrying about perfection and just keep on painting... I've since lost the essay to the digital depths, but I still think about it now and then. I still resonate with its sentiments.

◊post-section{RC: Return}
In true RC form, here's the traditional "return statement," in which I reflect on my time at Recurse, think about what comes next, and add to the corpus of Recurse-related outreach floating around on the internet.

◊mark{In short, I had a really great time.} I think it's a rare and beautiful experience for a certain kind of programmer at a certain stage in their life. If the values of Recurse resonate with you and if you are at a point in life where you really want to have the freedom to work on things you personally care about and grow in the ways that ◊em{you} want to grow (also probably most importantly: ◊em{if you are at a place where you can afford to take a 6- or 12-week break from money-making work}), ◊mark{Recurse is well worth applying to and, hopefully, attending.}
...
◊post-section{No Way Home}
There is a strange sense that this is a particular marker for me in my life --- a time when lots of things are at once ending and beginning. I quit my job, the intermediate, buffering space that RC provided is over, I'm starting an MS program in a new city, in a new state, and I'm really committing to something that I believe in, that I'm deeply interested in, and that I can envision being the core of a career for me.

I'm really going to miss being in New York City and hanging out with all my college friends. In some ways, I miss the financial comforts of having an industry programming job and the relative stability of corporate life. I think there are millions of tiny things you don't quite realize you took for granted when you live and exist somewhere. It's only when you leave a place that you really feel their unexpected absence.

But I'm very excited about where I am now and where I want to go. And there really is nowhere to go but forward. Who knows where it all will lead?
