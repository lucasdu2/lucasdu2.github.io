...
At the end of the day, I'm just not sure how useful these kinds of talks are. I think people will end up doing things that align with their values and that make them broadly happy. The hard part is trying to tease those values out. For the most part, generalized advice and guidance like the kind given in this talk don't really help with that.

If someone really cares about doing great research above all, at least in the way Hamming figures, they'll figure out a lot of these things from Hamming's talk relatively naturally, on their own. Or Hamming's talk may resonate, provide validation, and help in some way. But if someone cares deeply about nurturing their life outside of work, for example, there might not be much to take away. Perhaps the talk is even actively harmful. There is more to life than doing "great" research, by whatever standard Hamming is talking about. And that is perfectly OK.

There's also a good deal of cynicism in the talk that I find distasteful. Human relationships are not just a means to end and shouldn't be viewed as such. Conversations with peers have more value than simply "stimulating" your own thoughts. Saying "you can be a nice guy or you can be a great scientist" is simplistic at best and damaging at worst—being kind, generous, compassionate, and "nice" in the broad sense should be a prequisite for any sort of greatness. The "brilliant asshole" shtick in academia, and in computer science/programming more generally, needs to go.

There's more to success than just some bar of research quality that Hamming has in mind or the kind of legacy that someone leaves behind. Legacy, public praise, and external prestige aren't necessarily correlated to real, quality work or meaningful contribution. Being happy and fulfilled, I think, is truly the most important thing. If you find that purely in doing research, great! But it's OK to enjoy research and also want something more outside of that. It's OK to not spend your entire life on your work. There's always a tradeoff, but you can still add something worthwhile to the conversation.

I think there is a toxic undercurrent of constant comparison, overwork, and self-flagellation that runs in academia and that drives people away. We can do without that. At least I can.

And really, a talk like this just reveals the perspective of an individual. No matter how accomplished the individual, they have flaws, shortcomings, and blind spots. And like any other sort of advice, it should be taken with a hefty grain of salt. 

◊|divider|

Regardless, I'm going to try to hunker down and spend the next month or so continuing to learn more about SAT/SMT solvers and separation logic in hopes of doing some novel research on verifying concurrent data structures.
...
◊fndef[1]{Here are the contents of the first footnote.}
