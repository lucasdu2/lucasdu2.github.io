...
The best part about Recurse is that I get to hang out with a bunch of people who A) ◊em{are excited about programming and computing} and B) ◊em{want to share that excitement in ways that edify others}. It's refreshing. I think it's rare. And I think Recurse does an ◊link["https://www.recurse.com/social-rules"]{excellent} ◊link["https://www.recurse.com/self-directives"]{job} of creating and fostering that kind of community.
