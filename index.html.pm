...
My primary goal is to ◊em{put stronger provable guarantees about real-world software systems within reach of more programmers}. A secondary, related goal is to ◊em{drastically reduce the complexity of concurrent and distributed applications} (while preserving or even increasing performance).
