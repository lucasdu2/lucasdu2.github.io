...
Currently, I'm interested in the ◊strong{formal verification of concurrent and distributed systems}. I want strong formal guarantees, specifically about correctness and security, from foundational systems (i.e. databases, filesystems, browsers) and web-based applications.
...
Broadly, I believe practical software development can be much more rigorous and elegant. Programming languages and formal methods offer a theoretically rich and principled place to start. There is a lot of room for mathematical abstractions to give us much better results across the computing stack and as software underpins more and more of our lives, ◊em{we need better results}.
